...
| Script | Description | OS | Non-root |
| ------ | ----------- | -- | -------- |
...
| [`setup/unix/install-nerd-fonts.sh`](https://github.com/humblebeeai/script-common/raw/main/src/setup/unix/install-nerd-fonts.sh) | Install Nerd Fonts | Unix/Linux/macOS | ✅ |
